...
+(UIImage *)phImageWithSize:(CGSize)fullSize zoom:(CGFloat)zoom{
    return [[UIImage imageNamed:@"default_Image"] remakeImageWithFullSize:fullSize zoom:zoom];
//    return [[UIImage imageNamed:@"empty_picture"] remakeImageWithFullSize:fullSize zoom:zoom];
//    return [[[UIImage alloc] init] remakeImageWithFullSize:fullSize zoom:zoom];
}
