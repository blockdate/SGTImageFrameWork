...
@interface CTAssetsGroupViewController()<UITableViewDelegate, UITableViewDataSource>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    vc.creatAlbumSourceController = self.creatAlbumSourceController;
    vc.shouldDismissWhenFinished = _shouldDismissWhenFinished;
