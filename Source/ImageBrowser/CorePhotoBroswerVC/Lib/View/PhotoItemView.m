...
@property (nonatomic,strong) UILongPressGestureRecognizer *tap_long_viewGesture;
...
-(void)awakeFromNib{
    ...
    [self addGestureRecognizer:self.tap_long_viewGesture];
...
-(void)tap_long_viewTap:(UITapGestureRecognizer *)tap{
    if (_ItemViewLongPressBlock != nil) {
        _ItemViewLongPressBlock();
    }
}
...
-(UILongPressGestureRecognizer *)tap_long_viewGesture{
    
    if(_tap_long_viewGesture == nil){
        
        _tap_long_viewGesture =[[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(tap_long_viewTap:)];
        [_tap_long_viewGesture requireGestureRecognizerToFail:self.tap_single_viewGesture];
    }
    
    return _tap_long_viewGesture;
}
