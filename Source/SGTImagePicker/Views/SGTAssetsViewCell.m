...
@implementation SGTAssetsViewCell
...
- (void)fillWithAsset:(SGTImageAsset *)asset isSelected:(BOOL)seleted
{
    ...
    self.asset = asset;
//    CGImageRef thumbnailImageRef = [asset.alAsset thumbnail];
    self.imageView.image = asset.image;//[UIImage imageWithCGImage:thumbnailImageRef];
