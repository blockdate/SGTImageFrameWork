...
- (void)displayImage {
    ...
    if ([_asset isKindOfClass:[ALAsset class]]) {
        ...
        self.photoImageView.frame = photoImageViewFrame;
        self.zoomingScrollView.contentSize = photoImageViewFrame.size;
    }else if ([_asset isKindOfClass:[SGTImageAsset class]]){
        SGTImageAsset *as = (SGTImageAsset *)_asset;
        UIImage *img = as.fullScreenImage;
        self.photoImageView.image = img;
        self.photoImageView.hidden = NO;
        CGRect photoImageViewFrame;
        photoImageViewFrame.origin = CGPointZero;
